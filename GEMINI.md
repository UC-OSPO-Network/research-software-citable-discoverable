...
- **Lesson Order/Structure**: 
  - `config.yaml`: has a key of `episodes` that gives the order of the episodes. 
  - `idex.md`: is lesson home page and has lesson level learning objectives & prerequisites
